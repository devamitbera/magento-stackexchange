...
{
    const PAYMENT_METHOD_PAYU_CODE = 'payu';
     ...
     * @var string
     */
    protected $_code = self::PAYMENT_METHOD_PAYU_CODE;
     ...
     * @var string
     */
    protected $_formBlockType = 'BlueHorse\Payu\Block\Form\Payu';
 ...
 /**
   ...
   /**
    ...
    {
        return $this->_urlBuilder->getUrl('cms/index/index');
    }
    
   public function getOrderPlaceRedirectUrl()
    {
        
         return $this->_urlBuilder->getUrl('contact/index/index');
    }
